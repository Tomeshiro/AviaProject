...
INSERT INTO `user` (`user_id`, `pwd`, `name`, `email`, `phone_no`, `address`, `role`) VALUES
('admin', 'password', 'admin', 'dimasik2003@mail.ru', '123621351', 'Sarapul', 'admin'),
('aadith', 'aadith007', 'aadith_name', 'aadith_email', '12345', 'aadith_address', 'normal'),
('Apple', 'abhishek', 'Abhijeeth', 'gmail@gmail.com', '+9185564764', 'hgsjhgdjfdjdgf', 'normal'),
('KUMAR', '123456789', 'RUKO SINGH', 'KUMAR@GMAIL.COM', '1234567890', 'INDIANINDIA', 'normal'),
('SANCHIT', '123456', 'SANCHIT KUMAR', 'sanchit.muz@gmail.com', '1234569870', 'India', 'normal');
...
(1, '1669050', 'Harry Roshan', 20, 'male', 'yes'),
(1, '2033264', 'RAKHI', 25, 'female', 'yes'),
(1, '2179656', 'KIMI', 11, 'male', 'yes'),
(1, '2369143', 'blah', 20, 'male', 'yes'),
(1, '3027167', 'aadith_name', 10, 'male', 'yes'),
(1, '3773951', 'harry', 51, 'male', 'yes'),
(1, '3817993', 'SANCHIT KUMAR', 23, 'male', 'yes'),
(1, '4797983', 'pass1', 34, 'male', 'yes'),
(1, '4807312', 'SANCHIT', 22, 'male', 'yes'),
(1, '5272308', 'SHUBHANGI SINGH', 1, 'female', 'yes'),
(1, '5421865', 'pass1', 10, 'male', 'yes'),
(1, '6980157', 'roshan', 20, 'male', 'yes'),
(1, '8503285', 'aadith_name', 10, 'male', 'yes'),
(1, '9288360', 'SANCHIT KUMAR', 23, 'male', 'yes'),
(2, '1669050', 'berti harry', 45, 'female', 'yes'),
(2, '2369143', 'blah', 51, 'male', 'yes'),
(2, '3027167', 'roshan', 20, 'male', 'yes'),
(2, '3773951', 'berti', 42, 'female', 'yes'),
(2, '3817993', 'RANJIT KUMAR', 26, 'male', 'yes'),
(2, '4797983', 'Harry Roshan', 20, 'male', 'yes'),
(2, '4807312', 'RANJIT', 66, 'male', 'yes'),
(2, '5421865', 'pass2', 20, 'female', 'yes'),
(2, '6980157', 'aadith', 9, 'male', 'yes'),
(2, '8503285', 'roshan_name', 20, 'male', 'yes'),
(2, '9288360', 'SHUBHAM KUMAR', 24, 'male', 'yes'),
(3, '1669050', 'aadith_name', 10, 'male', 'yes'),
(3, '2369143', 'blah', 10, 'male', 'yes'),
(3, '3773951', 'aadith', 11, 'male', 'yes'),
(3, '4797983', 'aadith_name', 10, 'male', 'yes'),
(3, '4807312', 'SURESH', 22, 'male', 'yes'),
(3, '5421865', 'pass3', 30, 'male', 'yes'),
(4, '2369143', 'blah', 42, 'female', 'yes'),
(4, '4807312', 'RAMESH', 65, 'male', 'yes'),
(5, '4807312', 'SHYAMA', 22, 'female', 'yes');
...
INSERT INTO `ticket_details` (`pnr`, `date_of_reservation`, `flight_no`, `journey_date`, `class`, `booking_status`, `no_of_passengers`, `lounge_access`, `priority_checkin`, `insurance`, `payment_id`, `user_id`) VALUES
...
--
ALTER TABLE `ticket_details`
    ADD CONSTRAINT `ticket_details_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `ticket_details`
    ADD CONSTRAINT `ticket_details_ibfk_3` FOREIGN KEY (`flight_no`) REFERENCES `flight_details` (`flight_no`) ON DELETE SET NULL ON UPDATE CASCADE;
