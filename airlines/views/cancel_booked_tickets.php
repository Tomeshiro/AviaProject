...
<html>
	...
	<body>
		...
		<form action="../controllers/cancel_booked_tickets_form_handler.php" method="post">
			<h2>ОТМЕНА ЗАБРОНИРОВАННЫХ БИЛЕТОВ</h2>
			<?php
			...
			<table cellpadding="5" style="padding-left: 30px;">
				<tr>
					<td class="fix_table">Введите PNR</td>
				</tr>
				<tr>
			...
			<br>
			<input type="submit" value="Отменить билет" name="Cancel_Ticket">
		</form>
